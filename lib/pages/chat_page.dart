...
import 'package:firebasechat/services/auth/chat/chat_service.dart';
...
class _ChatPageState extends State<ChatPage> {
  ...
  Widget _buildMessageItem(DocumentSnapshot document) {
    ...
    // align the message to the right if the send er is to current user, otherwise to the left
